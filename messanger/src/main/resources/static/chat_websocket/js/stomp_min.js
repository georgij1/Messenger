(function() {
    ...
    Client = (function() {
        ...
        Client.prototype.connect = function() {
            ...
            if (typeof this.debug === "function") {
                this.debug("WebSocket сессия открывается...");
            }

            this.ws.onmessage = (function(_this) {
                return function(evt) {
                    let arr, c, client, data, frame, messageID, onreceive, subscription, _i, _len, _ref, _results;
                    ...
                    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                        ...
                        switch (frame.command) {
                            case "CONNECTED":
                                if (typeof _this.debug === "function") {
                                    _this.debug("Соединение к серверу - " + frame.headers.server);
                                }
            ...
            this.ws.onclose = (function(_this) {
                return function() {
                    let msg;
                    msg = "Потерянно соединение к серверу - " + _this.ws.url;
            ...
            return this.ws.onopen = (function(_this) {
                return function() {
                    if (typeof _this.debug === "function") {
                        _this.debug('WebSocket открылась...');
                    }
